        ...
        <div class="col-md-12">
            <div class="card col-7 card-default">
                <div class="card-header">
                    <h2 class="card-title"> Yangi Mahsulot</h2>
                </div>
                        ...
                        <div class="bs-stepper-content">
                            <div id="logins-part" class="col-12" role="tabpanel" aria-labelledby="logins-part-trigger">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" class="form-control" value="{{ old('price') }}" placeholder="Narx">
                                    @error('price')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="old_price" class="form-control" value="{{ old('old_price') }}" placeholder="Avvalgi narx">
                                </div>
